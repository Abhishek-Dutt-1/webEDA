					...
					<div class="12u">
						...
						<section class="box">
							...
							<?php
								...
								if (!(empty($Driver)) &&!(empty($KPI))) :
								{			
									
									?>
									<h3> <?php print $brand_value; ?></h3>
									<div class="row uniform half">
										<div class="6u" style="width:100%; overflow: auto; min-height:150px; max-height:500px;">
											<table class="alt" >
												<tr>
													<td></td>
													<?php 	
																...
																<?php 	foreach ($Driver as $driver_value)
																			{
																				...
																				unset($array1);
																				unset($array2);
																				echo '<td style="background-color:'.Correlation_color($correlation).'; vertical-align: middle; text-align: center;">';
																				//
																				echo '<a style="color: #646464;" href="#" onclick="displayGraphs(\''. $kpi_value.'\',\''. $driver_value.'\'); return false;">';
																				echo $correlation;
																				echo '</a>';
