...
<script type="text/x-template" id="selectionTableTemplate">
	...
	<div class="selectionColumn">
		<div class="selectionLabels"></div> <!-- upper left empty cell-->
	{#varTypes}
	...
	{#brands}
		<div class="selectionColumn">
			...
			<div class="selectionHeader">
				{brand} [<a href="#" onclick="selectionRemoveBrand('{brand}'); return false;">x</a>]
			</div>
			{#kpis}
			...
			<div class="selectionHeader">
				<div class="selectionAddMore">
					<a href="#" onclick="selectionAddBrand(); return false;" class="selectionAddMoreLink">Add Brand</a>
				</div>
			</div>
			{/brand}
		</div>
